      ...
      >
        ...
        <div className="p-4 sm:p-5 bg-neutral-50 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-xs uppercase px-6 py-3 rounded-lg shadow-sm tracking-wide transition-colors cursor-pointer"
          >
