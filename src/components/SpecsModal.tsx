      ...
      >
        ...
        <div className="relative h-48 sm:h-56 bg-neutral-900 overflow-hidden">
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white">
            <span className="inline-block bg-amber-400 text-neutral-950 text-xs font-bold uppercase px-2.5 py-0.5 rounded-sm tracking-wider mb-1">
              {vehicle.category}
            </span>
        ...
        <div className="p-5 sm:p-6 max-h-[60vh] overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-neutral-50 p-3.5 rounded-xl border border-neutral-200 text-center">
            <div>
              <span className="text-xs uppercase font-bold text-neutral-500">Capacity</span>
            ...
            <div>
              <span className="text-xs uppercase font-bold text-neutral-500">Gearbox</span>
              <div className="text-xs font-bold text-neutral-900 flex items-center justify-center gap-1 mt-0.5">
            ...
            <div>
              <span className="text-xs uppercase font-bold text-neutral-500">Fuel Type</span>
              <div className="text-xs font-bold text-neutral-900 flex items-center justify-center gap-1 mt-0.5">
            ...
            <div>
              <span className="text-xs uppercase font-bold text-neutral-500">Luggage</span>
              <div className="text-xs font-bold text-neutral-900 flex items-center justify-center gap-1 mt-0.5">
        ...
        <div className="p-4 sm:p-5 bg-neutral-50 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto btn-whatsapp flex items-center justify-center gap-2 font-bold text-xs px-6 py-3 rounded-lg shadow-sm tracking-wide transition-colors cursor-pointer"
          >
