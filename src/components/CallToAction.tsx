...
export const CallToAction: React.FC<CallToActionProps> = ({ onOpenBooking }) => {
  return (
    <section 
      ...
      className="bg-[#121316] text-white py-12 sm:py-16 border-t border-neutral-800"
    >
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-8">
            <button
              ...
              className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-black text-xs uppercase px-7 py-3.5 rounded-lg shadow-md tracking-wider transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center justify-center bg-white hover:bg-neutral-100 text-neutral-900 font-black text-xs uppercase px-6 py-3.5 rounded-lg shadow-sm tracking-wider transition-colors cursor-pointer"
            >
