              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-neutral-100 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="btn-gold text-xs font-bold px-4 py-2 rounded-lg transition-all cursor-pointer shadow-xs"
                  >
                    <span>Explore</span>
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-8 space-y-4">
                    ...
                    <div className="pt-3">
                      <button
                        onClick={() => handleBookService(serv.title)}
                        className="btn-whatsapp flex items-center gap-2 font-bold text-xs px-6 py-3 rounded-lg shadow-sm tracking-wide cursor-pointer transition-colors"
                      >
                  ...
                  <div className="lg:col-span-4 space-y-3 bg-neutral-50 p-4 rounded-xl border border-neutral-200">
                    <span className="text-xs uppercase font-bold text-neutral-500 tracking-wider block mb-1">
                      ...
                      serv.suitableVehicles.map((car, idx) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="btn-outline text-xs font-bold px-3 py-1.5 rounded-lg cursor-pointer transition-colors"
                          >
                            Specs
                          </button>
                        </div>
