  ...
  return (
    <div id="about-us-page-wrapper" className="animate-fadeIn">
      ...
      <div 
        ...
        className="text-white py-16 sm:py-20 border-b border-neutral-800"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <p 
            style={{ fontSize: '13px' }}
            className="text-neutral-300 sm:leading-relaxed font-normal max-w-2xl mx-auto"
          >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-neutral-950 leading-tight">
            ...
            {/* Badges Grid - Clean, without star/tick clutter */}
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl border border-neutral-200 bg-neutral-900">
              ...
              >
                ...
                <div className="text-[11px] text-neutral-300 truncate font-normal">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-2xs">
              ...
              <h4 className="text-sm font-black uppercase text-neutral-900 mb-2">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        <div 
          ...
          className="text-white rounded-2xl p-8 sm:p-12 border border-neutral-800 shadow-xl"
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 justify-center">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-amber-400 hover:bg-amber-500 text-black font-extrabold text-xs uppercase py-3.5 px-6 rounded-lg tracking-wider transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-[#1b4d2e] hover:bg-[#153e24] text-white font-extrabold text-xs uppercase py-3.5 px-6 rounded-lg tracking-wider transition-colors cursor-pointer"
              >
